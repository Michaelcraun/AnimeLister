...
- (IBAction)presentAlbumPickerView:(id)sender
{
    ...
    navigationController.navigationItem.rightBarButtonItem.tintColor = self.theme.tintColor;
    navigationController.navigationItem.leftBarButtonItem.tintColor = self.theme.tintColor;

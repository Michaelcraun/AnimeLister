...
class CompletedAnimeCell: AnimeCell {
    private let completedOnLabel: UILabel = {
        let label = UILabel()
    ...
    override func layoutSubviews() {
        ...
        completedOnLabel.text = "Finished on: \(anime.meta.endDate)"
